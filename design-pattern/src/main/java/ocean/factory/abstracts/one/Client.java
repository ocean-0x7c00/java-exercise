package ocean.factory.abstracts.one;

import ocean.factory.abstracts.one.factory.*;
import ocean.factory.abstracts.one.product.Button;
import ocean.factory.abstracts.one.product.ComboBox;
import ocean.factory.abstracts.one.product.TextField;
...
//
        ...
        ocean.factory.abstracts.origin.product.Button button = factory.createButton();
        ocean.factory.abstracts.origin.product.TextField textField = factory.createTextField();
        ocean.factory.abstracts.origin.product.ComboBox comboBox = factory.createComboBox();
    }
}
